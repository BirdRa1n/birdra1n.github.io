        ...
        <div className="relative z-10 max-w-4xl">
          ...
          >
            <span
              ...
              style={{ fontFamily: "var(--font-mono)", color: "var(--neon)", opacity: 0.7 }}
            >
              ~$
            </span>
            <span
          ...
          >
            Tech enthusiast and developer with experience in front-end and back-end
            development. Focused on creating exceptional digital solutions and
            improving the user experience through clean code and thoughtful design.
          </motion.p>
